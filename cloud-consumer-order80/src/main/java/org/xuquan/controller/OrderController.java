...
import org.xuquan.lb.LoadBalancer;
...
public class OrderController {
    ...
    @PostMapping("/consumer/payment/entity/create")
    public CommonResult<Payment> create4Entity(@RequestBody Payment payment) {
